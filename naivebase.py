...
# characters level tf-idf
    ...
    accuracy = train_model(valid_y,naive_bayes.MultinomialNB(), xtrain_count, train_y, xvalid_count)
    
    stri =""
    stri=stri+ "NB, Count Vectors: "+str(accuracy)+" + "

# Naive Bayes on Word Level TF IDF Vectors
    accuracy = train_model(valid_y,naive_bayes.MultinomialNB(), xtrain_tfidf, train_y, xvalid_tfidf)
    stri=stri+"NB, WordLevel TF-IDF: "+str(accuracy)+" + "

# Naive Bayes on Ngram Level TF IDF Vectors
    accuracy = train_model(valid_y,naive_bayes.MultinomialNB(), xtrain_tfidf_ngram, train_y, xvalid_tfidf_ngram)
    stri=stri+"NB, N-Gram Vectors: "+str(accuracy)+" + "
...
# Naive Bayes on Character Level TF IDF Vectors 
    ...
    stri=stri+"NB, CharLevel Vectors: "+str(accuracy)+" + "
    return stri
